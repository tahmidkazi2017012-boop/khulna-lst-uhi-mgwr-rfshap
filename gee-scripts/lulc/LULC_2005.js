...
var ndwi = annualComposite.normalizedDifference(["SR_B2", "SR_B4"]).rename("NDWI");
...
Map.addLayer(finalMap, {min:0, max:4, palette:lulcPalette}, "LULC 2005");
...
Export.image.toDrive({
  image: finalMap, description: '2005_LULC_Khulna',
